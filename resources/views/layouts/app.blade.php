        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="flex justify-between items-center py-3 md:justify-start md:space-x-10">
                ...
                <div class="-mr-2 -my-2 md:hidden">
                    <button onclick="buttonclickm();" type="button"
                            class="bg-gray-200 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none"
                            aria-expanded="false">
                ...
                <nav class="hidden md:flex space-x-10">
                    ...
                    @if(auth()->user())
                        <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" -->
                            <button onclick="buttonclicko();" type="button"
                                ...
                                <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                    <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                        ...
                                        <a href="{{route('createPet')}}"
                                           class="-m-3 p-3 flex items-start rounded-lg text-green-600 hover:no-underline">
                                            <!-- Heroicon -->
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                 fill="currentColor" class="bi bi-gem" viewBox="0 0 24 24">
                                                <path
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <p class="mt-1 text-sm text-gray-500">
                                                    Dodaj informacje o swoim pupilu
                                                </p>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <a href="{{route('editAddress')}}"
                                       class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50 hover:no-underline">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Dodaj swój adres aby móc skorzystać z opcji dodawania ogłoszenia
                                            </p>
                                        </div>
                                    </a>
                                    ...
                                    <a href="{{route('myWalks')}}"
                                       class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50 hover:no-underline">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Sprawdź ogłoszenia, które wystawiłeś
                                            </p>
                                        </div>
                                    </a>

                                    <a href="{{route('myAgreements')}}"
                                       class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50 hover:no-underline">
                                        <!-- Heroicon -->
                                        <svg class="flex-shrink-0 h-6 w-6 text-green-600"
                                             xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Sprawdź historię przyjętych zleceń
                                            </p>
                                        </div>
                                    </a>
                                </div>
                ...
                @auth()
                    <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                        <a class="ml-6 whitespace-nowrap inline-flex items-center justify-center px-3 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-600 hover:bg-green-700 hover:no-underline"
                           href="{{ route('logout') }}"
                    ...
                    <div class="mt-6">
                        <nav class="grid gap-y-8">
                            ...
                            <div class="-m-3 p-3 flex items-center rounded-md">
                                ...
                                <span
                                    class="flex font-bold ml-3 text-base font-medium text-gray-900 hover:no-underline">
                                        DoggerCoin:
                ...
                <div class="py-6 px-5 space-y-6">
                    ...
                    @auth()
                        <div>
                            ...
                            <a class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-600 hover:bg-green-700 hover:no-underline"
                               href="{{ route('logout') }}"
                               onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                {{ __('Wyloguj się') }}
