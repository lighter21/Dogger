                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ action('PetController@store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="type" class="form-control @error('type') is-invalid @enderror" required autocomplete="type" autofocus>
...
{{--                                    <input id="type" type="text" class="form-control @error('type') is-invalid @enderror" name="type" value="{{ old('type') }}" required autocomplete="type" autofocus>--}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="breed" class="form-control @error('breed') is-invalid @enderror" required autocomplete="breed" autofocus>
                                        <optgroup label="Psy">
