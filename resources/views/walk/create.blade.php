            ...
            @isset($myPets)
                ...
                <form class="mb-4 flex flex-wrap justify-between" method="post" action="{{route('storeWalk')}}">
                    ...
                    <div class="flex flex-col mb-4 md:w-1/2">
                        <label class="mb-2 uppercase tracking-wide font-bold text-lg text-gray-400" for="data">
                            Zwierzak </label>
                    ...
                    <div class="flex flex-col mb-4 md:w-1/2">
                        <label class="mb-2 uppercase font-bold text-lg text-gray-400 md:ml-2" for="date"> Data odbycia
                            spaceru </label>
                    ...
                    <div class="flex flex-col mb-4 w-full">
                        <label class="mb-2 uppercase font-bold text-lg text-gray-400" for="description"> Dodatkowe
                    ...
                    <button
                        class="block bg-green-400 hover:bg-green-500 text-white uppercase text-lg mx-auto p-4 rounded"
                        type="submit">Dodaj ogłoszenie
                    </button>
                    @endisset
                </form>
                @empty($myPets)
