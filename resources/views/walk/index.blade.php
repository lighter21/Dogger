        ...
        <div class="mx-24 grid md:grid-cols-2 lg:grid-cols-3">
            @if($walks)
                ...
                @foreach($walks as $walk)
                    <div class="m-6 bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl relative">
                        <!-- cards here -->
                        <img class="h-80 w-full object-cover" src="{{asset('img/dog.png')}}" alt="dog">
                        <div class="m-4">
                            <span
                                class="m-2 text-xl md:text-xl block text-center font-bold text-green-400">{{$walk->pet->breed}}</span>
                            <span
                                class="m-2 text-xl md:text-xl block text-center font-bold text-green-400">{{$walk->user->city}}</span>
                            <span
                            ...
                            <div class="flex justify-center">
                                <span
                                    ...
                                    <a class="text-green-400 hover:no-underline hover:text-green-400"
                                       href="{{ route('showWalk', $walk->id) }}"> Więcej informacji </a>
                                </span>
                            </div>
                        </div>
                    </div>
